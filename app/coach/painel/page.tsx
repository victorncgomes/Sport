            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        {/* NOVO: Treinos Ativos em Tempo Real */}
                        <AnimatedCard variant="gradient" className="p-8">
                            <div className="flex items-center justify-between mb-6">
                                <div>
                                    <h2 className="text-xl font-black text-white uppercase tracking-tighter">Treinos Ativos Agora</h2>
                                    <p className="text-white/30 text-xs uppercase font-bold tracking-widest">Monitoramento em Tempo Real</p>
                                </div>
                                <Activity className="w-6 h-6 text-club-red animate-pulse" />
                            </div>
                            <Link href="/coach/active-workouts" className="block">
                                <Button className="w-full bg-white/10 hover:bg-white/20 border border-white/20">
                                    Ver Todos os Treinos Ativos
                                    <ArrowRight className="w-4 h-4 ml-2" />
                                </Button>
                            </Link>
                        </AnimatedCard>

                        {/* NOVO: Reservas Pendentes */}
                        <AnimatedCard variant="glass" className="p-8 border-orange-500/20">
                            <div className="flex items-center justify-between mb-6">
                                <div>
                                    <h2 className="text-xl font-black text-white uppercase tracking-tighter">Reservas Pendentes</h2>
                                    <p className="text-white/30 text-xs uppercase font-bold tracking-widest">Aguardando Aprovação</p>
                                </div>
                                <Anchor className="w-6 h-6 text-orange-400" />
                            </div>
                            <Link href="/coach/pending-reservations" className="block">
                                <Button className="w-full bg-orange-500/10 hover:bg-orange-500/20 border border-orange-500/30 text-orange-400">
