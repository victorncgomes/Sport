...
export default function DiretoriaLoginPage() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        window.location.href = '/diretoria';
    };
            ...
            >
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-2xl sm:text-3xl font-bold text-white mb-2">
                        Área da <span className="text-club-red">Diretoria</span>
                    </h1>
                    <p className="text-white/50">Gestão Completa do Clube</p>
                </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                placeholder="diretoria@scnatal.com.br"
